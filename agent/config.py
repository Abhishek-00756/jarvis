...
MEMORY_PATH = os.path.expanduser(
    os.environ.get("JARVIS_MEMORY_PATH", "~/.jarvis_agent/memory")
)
Path(MEMORY_PATH).mkdir(parents=True, exist_ok=True)

CONFIRM_REQUIRED_TOOLS = {
    "run_shell_command","write_file","delete_file","open_app","click_ui_element","type_text","run_shortcut",
    "whatsapp_call","whatsapp_send_message","send_email","add_calendar_event","add_reminder","add_note",
    "browser_navigate","browser_click","share_reel_to_instagram_dm","lock_screen","sleep_mac","restart_mac",
    "shutdown_mac","close_window","move_file","copy_file","rename_file","trash_file","open_file","extract_archive",
    "delete_reminder","append_note","send_imessage","send_message","quit_app","click_menu_item","browser_fill",
}
